/* MPW_BUNDLE_PACKAGES [{"name":"entities","version":"4.5.0"},{"name":"entities","version":"8.0.0"},{"name":"linkify-it","version":"5.0.2"},{"name":"linkify-it","version":"6.1.0"},{"name":"markdown-it","version":"14.3.0"},{"name":"markdown-it","version":"15.0.0"},{"name":"mdurl","version":"2.1.0"},{"name":"orderedmap","version":"2.1.1"},{"name":"prosemirror-commands","version":"1.7.2"},{"name":"prosemirror-dropcursor","version":"1.8.3"},{"name":"prosemirror-history","version":"1.5.0"},{"name":"prosemirror-inputrules","version":"1.5.1"},{"name":"prosemirror-keymap","version":"1.2.3"},{"name":"prosemirror-markdown","version":"1.13.5"},{"name":"prosemirror-model","version":"1.25.11"},{"name":"prosemirror-schema-basic","version":"1.2.4"},{"name":"prosemirror-schema-list","version":"1.5.1"},{"name":"prosemirror-state","version":"1.4.4"},{"name":"prosemirror-transform","version":"1.12.0"},{"name":"prosemirror-view","version":"1.42.2"},{"name":"punycode.js","version":"2.3.1"},{"name":"rope-sequence","version":"1.3.4"},{"name":"uc.micro","version":"2.1.0"},{"name":"uc.micro","version":"3.0.0"},{"name":"w3c-keyname","version":"2.2.8"}] */
...
var Match = class {
  ...
  url;
  constructor(text3, schema3, index, lastIndex) {
    const raw = text3.slice(index, lastIndex);
    this.schema = schema3.toLowerCase();
    this.index = index;
...
var LinkifyIt = class {
  ...
  */
  add(schema3, definition = null) {
    if (!definition) delete this.__schemas__[schema3];
    else {
      const def = {
        normalize: (match2, self) => self.normalize(match2),
        ...definition
      };
      this.__schemas__[schema3] = def;
    }
    this.re.set({
      ...this.__opts__,
      schema_names: Object.keys(this.__schemas__)
  ...
  */
  testSchemaAt(text3, schema3, pos) {
    if (!this.__schemas__[schema3.toLowerCase()]) return 0;
    return this.__schemas__[schema3.toLowerCase()].validate(text3.slice(0, pos + this.__opts__.maxLength), pos, this);
  }
  /**
  ...
  */
  tlds(list3, keepOld = false) {
    list3 = Array.isArray(list3) ? list3 : [list3];
    if (!keepOld) this.__opts__.tlds = list3;
    else this.__opts__.tlds = this.__opts__.tlds.concat(list3);
    this.re.set({
      ...this.__opts__,
      schema_names: Object.keys(this.__schemas__)
    });
...
function replaceEntityPattern(match2, name) {
  if (name.charCodeAt(0) === 35 && DIGITAL_ENTITY_TEST_RE.test(name)) {
    ...
    if (isValidEntityCode(code3)) return fromCodePoint(code3);
    return match2;
  }
  const decoded = decodeHTMLStrict(match2);
...
function isWhiteSpace(code3) {
  if (code3 >= 8192 && code3 <= 8202) return true;
  switch (code3) {
    case 9:
    case 10:
    case 11:
...
function isPunctCharCode(code3) {
  return isPunctChar(fromCodePoint(code3));
}
...
function parseLinkDestination(str, start, max) {
  ...
  if (str.charCodeAt(pos) === 60) {
    ...
    while (pos < max) {
      ...
      if (code3 === 10) return result;
      if (code3 === 60) return result;
      if (code3 === 62) {
        result.pos = pos + 1;
...
function parseLinkTitle(str, start, max, prev_state) {
  ...
  while (pos < max) {
    ...
    if (code3 === state.marker) {
      ...
      state.ok = true;
      return state;
    } else if (code3 === 40 && state.marker === 41) return state;
    else if (code3 === 92 && pos + 1 < max) pos++;
    pos++;
  }
...
var Ruler = class {
  ...
  */
  enable(list3, ignoreInvalid = false) {
  ...
  * @param ignoreInvalid Set `true` to ignore errors when rule not found.
  */
  enableOnly(list3, ignoreInvalid = false) {
    if (!Array.isArray(list3)) list3 = [list3];
    this.__rules__.forEach((rule) => {
      rule.enabled = false;
    });
  ...
  * @returns List of found rule names (if no exception happened).
  */
  disable(list3, ignoreInvalid = false) {
    if (!Array.isArray(list3)) list3 = [list3];
    const result = [];
    list3.forEach((name) => {
      const idx = this.__find__(name);
...
var StateBlock = class {
  ...
  skipChars(pos, code3) {
    for (let max = this.src.length; pos < max; pos++) if (this.src.charCodeAt(pos) !== code3) break;
    return pos;
  }
  skipCharsBack(pos, code3, min) {
    if (pos <= min) return pos;
    while (pos > min) if (code3 !== this.src.charCodeAt(--pos)) return pos + 1;
    return pos;
  }
...
function link(state, silent) {
  ...
  if (pos < max && state.src.charCodeAt(pos) === 40) {
    ...
    for (; pos < max; pos++) {
      ...
      if (!isSpace(code3) && code3 !== 10) break;
    }
    if (pos >= max) return false;
    start = pos;
  ...
  if (state.src.charCodeAt(pos + 1) === 35) {
    ...
    if (match2) {
      if (!silent) {
        ...
        const token = state.push("text_special", "", 0);
        token.content = isValidEntityCode(code3) ? fromCodePoint(code3) : fromCodePoint(65533);
...
var MarkdownIt = class {
  ...
  */
  enable(list3, ignoreInvalid = false) {
    ...
    const missed = list3.filter((name) => result.indexOf(name) < 0);
...
var TextNode = class _TextNode extends Node {
  ...
  */
  ...
  withText(text3) {
    if (text3 == this.text)
      return this;
    return new _TextNode(this.type, this.attrs, text3, this.marks);
  }
...
var Schema = class {
  ...
  */
  text(text3, marks2) {
    ...
    return new TextNode(type, type.defaultAttrs, text3, Mark.setFrom(marks2));
  }
  /**
...
__export(utils_exports2, {
  arrayReplaceAt: () => arrayReplaceAt2,
  asciiTrim: () => asciiTrim2,
  assign: () => assign,
  escapeHtml: () => escapeHtml2,
  escapeRE: () => escapeRE2,
  fromCodePoint: () => fromCodePoint3,
  has: () => has,
  isMdAsciiPunct: () => isMdAsciiPunct2,
  isPunctChar: () => isPunctChar2,
  isPunctCharCode: () => isPunctCharCode2,
  isSpace: () => isSpace2,
  isString: () => isString,
  isValidEntityCode: () => isValidEntityCode2,
  isWhiteSpace: () => isWhiteSpace2,
  lib: () => lib2,
  normalizeReference: () => normalizeReference2,
  unescapeAll: () => unescapeAll2,
  unescapeMd: () => unescapeMd2
});
...
// node_modules/prosemirror-markdown/node_modules/entities/lib/esm/generated/decode-data-html.js
...
// node_modules/prosemirror-markdown/node_modules/entities/lib/esm/generated/decode-data-xml.js
var decode_data_xml_default = new Uint16Array(
  // prettier-ignore
  "\u0200aglq	\x1B\u026D\0\0p;\u4026os;\u4027t;\u403Et;\u403Cuot;\u4022".split("").map((c) => c.charCodeAt(0))
);

// node_modules/prosemirror-markdown/node_modules/entities/lib/esm/decode_codepoint.js
var _a;
...
function replaceCodePoint2(codePoint) {
  ...
  return (_a2 = decodeMap2.get(codePoint)) !== null && _a2 !== void 0 ? _a2 : codePoint;
}

// node_modules/prosemirror-markdown/node_modules/entities/lib/esm/decode.js
var CharCodes2;
(function(CharCodes3) {
  CharCodes3[CharCodes3["NUM"] = 35] = "NUM";
  CharCodes3[CharCodes3["SEMI"] = 59] = "SEMI";
...
function isAsciiAlphaNumeric2(code3) {
...
function isEntityInAttributeInvalidEnd2(code3) {
  return code3 === CharCodes2.EQUALS || isAsciiAlphaNumeric2(code3);
}
...
var htmlDecoder2 = getDecoder2(decode_data_html_default);
var xmlDecoder = getDecoder2(decode_data_xml_default);
function decodeHTML2(str, mode = DecodingMode2.Legacy) {
...
// node_modules/prosemirror-markdown/node_modules/entities/lib/esm/generated/encode-html.js
...
// node_modules/prosemirror-markdown/node_modules/entities/lib/esm/escape.js
...
// node_modules/prosemirror-markdown/node_modules/entities/lib/esm/index.js
var EntityLevel2;
(function(EntityLevel3) {
  EntityLevel3[EntityLevel3["XML"] = 0] = "XML";
  EntityLevel3[EntityLevel3["HTML"] = 1] = "HTML";
...
var UNESCAPE_ALL_RE2 = new RegExp(UNESCAPE_MD_RE2.source + "|" + ENTITY_RE.source, "gi");
var DIGITAL_ENTITY_TEST_RE2 = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;
function replaceEntityPattern2(match2, name) {
  if (name.charCodeAt(0) === 35 && DIGITAL_ENTITY_TEST_RE2.test(name)) {
    const code3 = name[1].toLowerCase() === "x" ? parseInt(name.slice(2), 16) : parseInt(name.slice(1), 10);
    if (isValidEntityCode2(code3)) {
      return fromCodePoint3(code3);
    }
    return match2;
  }
  const decoded = decodeHTML2(match2);
  if (decoded !== match2) {
    return decoded;
  }
  return match2;
...
function unescapeAll2(str) {
  ...
  return str.replace(UNESCAPE_ALL_RE2, function(match2, escaped, entity3) {
    if (escaped) {
      return escaped;
    }
    return replaceEntityPattern2(match2, entity3);
  });
}
...
function isPunctCharCode2(code3) {
  return isPunctChar2(fromCodePoint3(code3));
}
...
function isAsciiTrimmable2(c) {
  return c === 32 || c === 9 || c === 10 || c === 13;
}
function asciiTrim2(str) {
  let start = 0;
  for (; start < str.length; start++) {
    if (!isAsciiTrimmable2(str.charCodeAt(start))) {
      break;
    }
  }
  let end = str.length - 1;
  for (; end >= start; end--) {
    if (!isAsciiTrimmable2(str.charCodeAt(end))) {
      break;
    }
  }
  return str.slice(start, end + 1);
}
var lib2 = { mdurl: mdurl_exports, ucmicro: uc_exports };
...
function parseLinkLabel2(state, start, disableNested) {
  let level, found2, marker, prevPos;
  const max = state.posMax;
  const oldPos = state.pos;
  state.pos = start + 1;
...
function parseLinkDestination2(str, start, max) {
  let code3;
  let pos = start;
  const result = {
    ok: false,
...
function parseLinkTitle2(str, start, max, prev_state) {
  let code3;
  let pos = start;
  const state = {
  ...
  while (pos < max) {
    ...
    if (code3 === state.marker) {
      state.pos = pos + 1;
      state.str += unescapeAll2(str.slice(start, pos));
      state.ok = true;
      return state;
...
default_rules2.fence = function(tokens, idx, options, env, slf) {
  const token = tokens[idx];
  const info = token.info ? unescapeAll2(token.info).trim() : "";
  let langName = "";
  let langAttrs = "";
  if (info) {
    const arr = info.split(/(\s+)/g);
...
function Renderer2() {
  this.rules = assign({}, default_rules2);
}
...
Ruler2.prototype.enable = function(list3, ignoreInvalid) {
...
Ruler2.prototype.enableOnly = function(list3, ignoreInvalid) {
  if (!Array.isArray(list3)) {
    list3 = [list3];
  }
...
Ruler2.prototype.disable = function(list3, ignoreInvalid) {
  if (!Array.isArray(list3)) {
    list3 = [list3];
  }
  const result = [];
...
StateCore2.prototype.Token = token_default;
var state_core_default = StateCore2;
...
function linkify2(state) {
  ...
  for (let j = 0, l = blockTokens.length; j < l; j++) {
    ...
    for (let i = tokens.length - 1; i >= 0; i--) {
      ...
      if (currentToken.type === "html_inline") {
        if (isLinkOpen2(currentToken.content) && htmlLinkLevel > 0) {
          htmlLinkLevel--;
        }
        if (isLinkClose2(currentToken.content)) {
          htmlLinkLevel++;
        }
      }
      if (htmlLinkLevel > 0) {
      ...
      if (currentToken.type === "text" && state.md.linkify.test(currentToken.content)) {
        ...
        blockTokens[j].children = tokens = arrayReplaceAt2(tokens, i, nodes2);
      }
    }
  }
}
...
function replaceFn2(match2, name) {
  return SCOPED_ABBR2[name.toLowerCase()];
}
...
var QUOTE_RE2 = /['"]/g;
var APOSTROPHE2 = "\u2019";
function addReplacement2(replacements, tokenIdx, pos, ch) {
  if (!replacements[tokenIdx]) {
    replacements[tokenIdx] = [];
  }
  replacements[tokenIdx].push({ pos, ch });
}
function applyReplacements2(str, replacements) {
  let result = "";
  let lastPos = 0;
  replacements.sort((a, b) => a.pos - b.pos);
  for (let i = 0; i < replacements.length; i++) {
...
function process_inlines2(tokens, state) {
  ...
  for (let i = 0; i < tokens.length; i++) {
    ...
    OUTER:
      while (pos < max) {
        ...
        const isLastPunctChar = isMdAsciiPunct2(lastChar) || isPunctCharCode2(lastChar);
        const isNextPunctChar = isMdAsciiPunct2(nextChar) || isPunctCharCode2(nextChar);
        ...
        if (!canOpen && !canClose) {
          if (isSingle) {
            addReplacement2(replacements, i, t.index, APOSTROPHE2);
          }
          continue;
        }
        if (canClose) {
          for (j = stack.length - 1; j >= 0; j--) {
            ...
            if (item.single === isSingle && stack[j].level === thisLevel) {
              ...
              addReplacement2(replacements, i, t.index, closeQuote);
              addReplacement2(replacements, item.token, item.pos, openQuote);
              stack.length = j;
              continue OUTER;
            }
          }
  ...
  Object.keys(replacements).forEach(function(tokenIdx) {
    tokens[tokenIdx].content = applyReplacements2(tokens[tokenIdx].content, replacements[tokenIdx]);
  });
}
function smartquotes2(state) {
  if (!state.md.options.typographer) {
    return;
  }
  for (let blkIdx = state.tokens.length - 1; blkIdx >= 0; blkIdx--) {
...
var _rules3 = [
  ...
  ["smartquotes", smartquotes2],
  // `text_join` finds `text_special` tokens (for escape sequences)
  // and joins them with the rest of the text
  ["text_join", text_join2]
];
function Core() {
...
StateBlock2.prototype.skipEmptyLines = function skipEmptyLines(from) {
...
StateBlock2.prototype.skipChars = function skipChars(pos, code3) {
  for (let max = this.src.length; pos < max; pos++) {
...
StateBlock2.prototype.skipCharsBack = function skipCharsBack(pos, code3, min) {
  if (pos <= min) {
    return pos;
  }
  while (pos > min) {
...
StateBlock2.prototype.Token = token_default;
var state_block_default = StateBlock2;

// node_modules/prosemirror-markdown/node_modules/markdown-it/lib/rules_block/table.mjs
var MAX_AUTOCOMPLETED_CELLS2 = 65536;
...
function table2(state, startLine, endLine, silent) {
  ...
  let lineText = getLine2(state, startLine + 1);
  let columns = lineText.split("|");
  const aligns = [];
  for (let i = 0; i < columns.length; i++) {
    const t = columns[i].trim();
  ...
  for (nextLine = startLine + 2; nextLine < endLine; nextLine++) {
    ...
    if (columns.length && columns[columns.length - 1] === "") columns.pop();
    autocompletedCells += columnCount - columns.length;
    if (autocompletedCells > MAX_AUTOCOMPLETED_CELLS2) {
      break;
    }
    if (nextLine === startLine + 2) {
      const token_tbo = state.push("tbody_open", "tbody", 1);
...
function fence2(state, startLine, endLine, silent) {
  let pos = state.bMarks[startLine] + state.tShift[startLine];
  let max = state.eMarks[startLine];
  if (state.sCount[startLine] - state.blkIndent >= 4) {
    return false;
...
function hr2(state, startLine, endLine, silent) {
  const max = state.eMarks[startLine];
  if (state.sCount[startLine] - state.blkIndent >= 4) {
    return false;
  }
...
function list2(state, startLine, endLine, silent) {
  let max, pos, start, token;
  let nextLine = startLine;
  let tight = true;
  if (state.sCount[nextLine] - state.blkIndent >= 4) {
...
function reference2(state, startLine, _endLine, silent) {
  let pos = state.bMarks[startLine] + state.tShift[startLine];
  let max = state.eMarks[startLine];
  let nextLine = startLine + 1;
  if (state.sCount[startLine] - state.blkIndent >= 4) {
  ...
  const label = normalizeReference2(str.slice(1, labelEnd));
  if (!label) {
    return false;
  }
  if (silent) {
...
function html_block2(state, startLine, endLine, silent) {
  ...
  let nextLine = startLine + 1;
  const endsOnBlankLine = HTML_SEQUENCES2[i][1].test("");
...
function heading2(state, startLine, endLine, silent) {
  ...
  token_o.map = [startLine, state.line];
  const token_i = state.push("inline", "", 0);
  token_i.content = asciiTrim2(state.src.slice(pos, max));
  token_i.map = [startLine, state.line];
  token_i.children = [];
...
function lheading2(state, startLine, endLine) {
  const terminatorRules = state.md.block.ruler.getRules("paragraph");
  if (state.sCount[startLine] - state.blkIndent >= 4) {
    return false;
  }
  ...
  const content = asciiTrim2(state.getLines(startLine, nextLine, state.blkIndent, false));
  state.line = nextLine + 1;
  const token_o = state.push("heading_open", "h" + String(level), 1);
  token_o.markup = String.fromCharCode(marker);
  token_o.map = [startLine, state.line];
...
var _rules4 = [
  ...
  ["table", table2, ["paragraph", "reference"]],
  ["code", code2],
  ["fence", fence2, ["paragraph", "reference", "blockquote", "list"]],
  ["blockquote", blockquote2, ["paragraph", "reference", "blockquote", "list"]],
  ["hr", hr2, ["paragraph", "reference", "blockquote", "list"]],
  ["list", list2, ["paragraph", "reference", "blockquote"]],
  ["reference", reference2],
  ["html_block", html_block2, ["paragraph", "reference", "blockquote"]],
  ["heading", heading2, ["paragraph", "reference", "blockquote"]],
  ["lheading", lheading2],
  ["paragraph", paragraph2]
];
function ParserBlock2() {
  this.ruler = new ruler_default();
  for (let i = 0; i < _rules4.length; i++) {
...
ParserBlock2.prototype.State = state_block_default;
var parser_block_default = ParserBlock2;
...
StateInline2.prototype.Token = token_default;
var state_inline_default = StateInline2;
...
function linkify3(state, silent) {
  ...
  if (state.src.charCodeAt(pos + 1) !== 47) return false;
  if (state.src.charCodeAt(pos + 2) !== 47) return false;
  const match2 = state.pending.match(SCHEME_RE2);
  if (!match2) return false;
  const proto = match2[1];
  const link3 = state.md.linkify.matchAtStart(state.src.slice(pos - proto.length));
  if (!link3) return false;
...
function newline2(state, silent) {
  let pos = state.pos;
...
function backtick2(state, silent) {
  let pos = state.pos;
  const ch = state.src.charCodeAt(pos);
  if (ch !== 96) {
    return false;
...
function strikethrough_tokenize2(state, silent) {
  const start = state.pos;
  const marker = state.src.charCodeAt(start);
  if (silent) {
    return false;
...
function strikethrough_postProcess2(state) {
  const tokens_meta = state.tokens_meta;
  const max = state.tokens_meta.length;
...
var strikethrough_default2 = {
  tokenize: strikethrough_tokenize2,
  postProcess: strikethrough_postProcess2
};

// node_modules/prosemirror-markdown/node_modules/markdown-it/lib/rules_inline/emphasis.mjs
function emphasis_tokenize2(state, silent) {
  const start = state.pos;
  const marker = state.src.charCodeAt(start);
  if (silent) {
    return false;
...
function emphasis_post_process2(state) {
  const tokens_meta = state.tokens_meta;
  const max = state.tokens_meta.length;
...
var emphasis_default2 = {
  tokenize: emphasis_tokenize2,
  postProcess: emphasis_post_process2
};
...
function html_inline2(state, silent) {
  ...
  const match2 = state.src.slice(pos).match(HTML_TAG_RE2);
  if (!match2) {
    return false;
  }
  if (!silent) {
    const token = state.push("html_inline", "", 0);
    token.content = match2[0];
    if (isLinkOpen3(token.content)) state.linkLevel++;
    if (isLinkClose3(token.content)) state.linkLevel--;
  }
  state.pos += match2[0].length;
  return true;
}
...
function entity2(state, silent) {
  ...
  const ch = state.src.charCodeAt(pos + 1);
  if (ch === 35) {
    const match2 = state.src.slice(pos).match(DIGITAL_RE2);
    if (match2) {
      if (!silent) {
        const code3 = match2[1][0].toLowerCase() === "x" ? parseInt(match2[1].slice(1), 16) : parseInt(match2[1], 10);
        const token = state.push("text_special", "", 0);
        token.content = isValidEntityCode2(code3) ? fromCodePoint3(code3) : fromCodePoint3(65533);
        token.markup = match2[0];
        token.info = "entity";
      }
      state.pos += match2[0].length;
    ...
    const match2 = state.src.slice(pos).match(NAMED_RE2);
    if (match2) {
      const decoded = decodeHTMLStrict2(match2[0]);
      if (decoded !== match2[0]) {
        if (!silent) {
          const token = state.push("text_special", "", 0);
          token.content = decoded;
...
function fragments_join2(state) {
  let curr, last;
  let level = 0;
  const tokens = state.tokens;
  const max = state.tokens.length;
...
var _rules5 = [
  ...
  ["escape", escape3],
  ["backticks", backtick2],
  ["strikethrough", strikethrough_default2.tokenize],
  ["emphasis", emphasis_default2.tokenize],
  ["link", link2],
  ["image", image2],
  ["autolink", autolink2],
  ["html_inline", html_inline2],
  ["entity", entity2]
];
var _rules22 = [
  ["balance_pairs", link_pairs2],
  ["strikethrough", strikethrough_default2.postProcess],
  ["emphasis", emphasis_default2.postProcess],
  // rules for pairs separate '**' into its own text tokens, which may be left unused,
  // rule below merges unused segments back with the rest of the text
  ["fragments_join", fragments_join2]
];
function ParserInline2() {
  this.ruler = new ruler_default();
  for (let i = 0; i < _rules5.length; i++) {
    this.ruler.push(_rules5[i][0], _rules5[i][1]);
  }
...
ParserInline2.prototype.State = state_inline_default;
var parser_inline_default = ParserInline2;
...
function Match2(text3, schema3, index, lastIndex) {
  const raw = text3.slice(index, lastIndex);
  this.schema = schema3.toLowerCase();
  this.index = index;
  this.lastIndex = lastIndex;
...
function LinkifyIt2(schemas, options) {
  ...
  this.__schemas__ = assign2({}, defaultSchemas2, schemas);
  this.__compiled__ = {};
...
LinkifyIt2.prototype.add = function add2(schema3, definition) {
...
LinkifyIt2.prototype.test = function test(text3) {
  if (!text3.length) {
    return false;
  }
  let m, re;
...
LinkifyIt2.prototype.pretest = function pretest(text3) {
  return this.re.pretest.test(text3);
};
LinkifyIt2.prototype.testSchemaAt = function testSchemaAt(text3, schema3, pos) {
  if (!this.__compiled__[schema3.toLowerCase()]) {
    return 0;
  }
  return this.__compiled__[schema3.toLowerCase()].validate(text3, pos, this);
};
LinkifyIt2.prototype.match = function match(text3) {
  const result = [];
  const type_schemed = [];
  ...
  for (; ; ) {
    ...
    const match2 = new Match2(text3, candidate.schema, candidate.index, candidate.lastIndex);
...
LinkifyIt2.prototype.matchAtStart = function matchAtStart(text3) {
  if (!text3.length) return null;
  const m = this.re.schema_at_start.exec(text3);
  if (!m) return null;
  const len = this.testSchemaAt(text3, m[2], m[0].length);
  if (!len) return null;
  const match2 = new Match2(text3, m[2], m.index + m[1].length, m.index + m[0].length + len);
  this.__compiled__[match2.schema].normalize(match2, this);
  return match2;
};
LinkifyIt2.prototype.tlds = function tlds(list3, keepOld) {
  list3 = Array.isArray(list3) ? list3 : [list3];
  if (!keepOld) {
...
LinkifyIt2.prototype.normalize = function normalize3(match2) {
  if (!match2.schema) {
...
function validateLink(url) {
  const str = url.trim().toLowerCase();
  return BAD_PROTO_RE2.test(str) ? GOOD_DATA_RE2.test(str) : true;
}
...
function normalizeLink(url) {
  ...
  if (parsed.hostname) {
    if (!parsed.protocol || RECODE_HOSTNAME_FOR2.indexOf(parsed.protocol) >= 0) {
      try {
        parsed.hostname = import_punycode2.default.toASCII(parsed.hostname);
      } catch (er) {
      }
    }
  }
...
function normalizeLinkText(url) {
  ...
  if (parsed.hostname) {
    if (!parsed.protocol || RECODE_HOSTNAME_FOR2.indexOf(parsed.protocol) >= 0) {
      try {
        parsed.hostname = import_punycode2.default.toUnicode(parsed.hostname);
      } catch (er) {
      }
    }
  }
...
function MarkdownIt2(presetName, options) {
  ...
  this.helpers = assign({}, helpers_exports2);
  this.options = {};
...
var MarkdownParseState = class {
  constructor(schema3, tokenHandlers2) {
    this.schema = schema3;
    this.tokenHandlers = tokenHandlers2;
    this.stack = [{ type: schema3.topNodeType, attrs: null, content: [], marks: Mark.none }];
  }
  top() {
...
function tokenHandlers(schema3, tokens) {
  let handlers = /* @__PURE__ */ Object.create(null);
  for (let type in tokens) {
    let spec = tokens[type];
    if (spec.block) {
      let nodeType = schema3.nodeType(spec.block);
...
var MarkdownParser = class {
  ...
  */
  constructor(schema3, tokenizer2, tokens) {
    this.schema = schema3;
    this.tokenizer = tokenizer2;
    this.tokens = tokens;
    this.tokenHandlers = tokenHandlers(schema3, tokens);
  }
  /**
...
var defaultMarkdownParser = new MarkdownParser(schema2, lib_default("commonmark", { html: false }), {
...
var defaultMarkdownSerializer = new MarkdownSerializer({
  ...
  code_block(state, node) {
    ...
    const fence3 = backticks ? backticks.sort().slice(-1)[0] + "`" : "```";
    state.write(fence3 + (node.attrs.params || "") + "\n");
...
var MarkdownSerializerState = class {
  ...
  */
  ...
  it will be escaped.
  */
  text(text3, escape4 = true) {
    let lines = text3.split("\n");
    for (let i = 0; i < lines.length; i++) {
      this.write();
      if (!escape4 && lines[i][0] == "[" && /(^|[^\\])\!$/.test(this.out))
        this.out = this.out.slice(0, this.out.length - 1) + "\\!";
      this.out += escape4 ? this.esc(lines[i], this.atBlockStart) : lines[i];
      if (i != lines.length - 1)
        this.out += "\n";
    }
  }
...
// src/validator.js
var ALIGNMENTS = /* @__PURE__ */ new Set(["left", "center", "right"]);
var SAFE_LINK = /^(https?:|mailto:)/i;
var IMAGE_PATH = /^images\/[\p{L}\p{N}](?:[\p{L}\p{N} ._-]*[\p{L}\p{N}_-])?$/u;
var SENTINEL_PREFIX = "MPWALIGN_7F2C_";
function aligned(spec) {
  return {
    ...
    toDOM(node) {
      ...
      const attrs2 = typeof original[1] === "object" && !Array.isArray(original[1]) ? original[1] : {};
      const offset = attrs2 === original[1] ? 2 : 1;
      const nextAttrs = {
        ...attrs2,
        "data-align": node.attrs.align,
        style: node.attrs.align === "left" ? void 0 : `text-align:${node.attrs.align}`
      };
      return [original[0], nextAttrs, ...original.slice(offset)];
    }
  };
}
var nodeSpecs = schema.spec.nodes.remove("code_block").remove("image").remove("hard_break").update("paragraph", aligned(schema.spec.nodes.get("paragraph"))).update("heading", aligned(schema.spec.nodes.get("heading")));
nodeSpecs = nodeSpecs.addToEnd("image", {
  ...
  toDOM(node) {
    return ["img", {
      ...
      "data-align": node.attrs.align,
      "data-upload-id": node.attrs.uploadId || void 0
    }];
  }
});
...
var editorSchema = new Schema({
  nodes: nodeSpecs,
  marks: schema.spec.marks.remove("em").remove("code")
});
var md = new MarkdownItCallable("commonmark", { html: false, linkify: false, typographer: false });
...
function transformImageParagraphs(tokens) {
  ...
  for (let index = 0; index < tokens.length; index += 1) {
    ...
    const inline3 = tokens[index + 1];
    const close2 = tokens[index + 2];
    if (open?.type === "paragraph_open" && inline3?.type === "inline" && close2?.type === "paragraph_close") {
      const visible = (inline3.children || []).filter((token) => token.type !== "text" || token.content.trim() !== "");
      if (visible.length === 1 && visible[0].type === "image") {
        const image3 = Object.assign(Object.create(Object.getPrototypeOf(visible[0])), visible[0]);
        image3.type = "image_block";
        image3.level = open.level;
        image3.block = true;
        result.push(image3);
        index += 2;
        continue;
...
var tokenizer = {
  parse(text3, env) {
    return transformImageParagraphs(md.parse(text3, env));
  }
};
var parser = new MarkdownParser(editorSchema, tokenizer, {
  blockquote: { block: "blockquote" },
...
function prepareAlignmentDirectives(markdown, diagnostics) {
  for (const match2 of markdown.matchAll(/(?<!!)\[[^\]]*\]\(\s*([^\s)]+)/g)) {
    const href = match2[1].replace(/^<|>$/g, "");
  ...
  lines.forEach((line, index) => {
    const match2 = allowed.exec(line);
    if (match2) {
      prepared.push(`${match2[1]}${SENTINEL_PREFIX}${match2[2]}`);
      const blankPrefix = match2[1].replace(/(?:[-+*]|\d+[.)])\s+$/, (value) => " ".repeat(value.length)).replace(/[ \t]+$/, "");
...
function consumeAlignmentSentinels(node, diagnostics) {
  ...
  node.forEach((original) => {
    ...
    const sentinel = child.type.name === "paragraph" && child.childCount === 1 && child.firstChild?.isText && child.firstChild.marks.length === 0 && new RegExp(`^${SENTINEL_PREFIX}(center|right)$`).test(child.textContent);
    if (sentinel) {
...
function validateDocument(doc, diagnostics = []) {
...
function renderInline(node) {
  ...
  node.forEach((child) => {
    ...
    let text3 = escapeHtml3(child.text || "");
    for (const mark of child.marks.slice().reverse()) {
      if (mark.type.name === "strong") text3 = `<strong style="font-weight:700">${text3}</strong>`;
      if (mark.type.name === "link" && SAFE_LINK.test(mark.attrs.href || "")) {
        text3 = `<a href="${escapeHtml3(mark.attrs.href)}" style="color:#576b95;text-decoration:none">${text3}</a>`;
      }
    }
    output += text3;
  });
...
function renderNode(node, imageData) {
  ...
  switch (node.type.name) {
    case "paragraph":
      return `<p style="${blockStyle};font-size:16px">${renderInline(node)}</p>`;
    case "heading": {
    ...
    case "image": {
      ...
      return `<p style="${blockStyle}"><img src="${src}" alt="${escapeHtml3(node.attrs.alt || "")}" style="max-width:100%;height:auto;display:inline-block" /></p>`;
    }
    case "horizontal_rule":
      return '<hr style="border:0;border-top:1px solid #e6e6e6;margin:24px 0" />';
    case "blockquote":
      return `<blockquote style="margin:16px 0;padding:8px 16px;border-left:4px solid #d9d9d9;background:#fafafa">${renderChildren(node, imageData)}</blockquote>`;
    case "bullet_list":
      return `<ul style="padding-left:1.6em;margin:0 0 16px">${renderChildren(node, imageData)}</ul>`;
    case "ordered_list":
      return `<ol start="${Number(node.attrs.order) || 1}" style="padding-left:1.6em;margin:0 0 16px">${renderChildren(node, imageData)}</ol>`;
    case "list_item":
      return `<li style="margin:4px 0">${renderChildren(node, imageData)}</li>`;
    default:
      throw new Error(`\u65E0\u6CD5\u590D\u5236\u672A\u652F\u6301\u8282\u70B9\uFF1A${node.type.name}`);
  }
}
function renderChildren(node, imageData) {
  let html = "";
  node.forEach((child) => {
    html += renderNode(child, imageData);
  });
  return html;
}
function renderConfirmedHtml(doc, imageData, themeCss) {
...
var constraints = { IMAGE_PATH, SAFE_LINK, ALIGNMENTS };
export {
  assertRoundTrip,
  constraints,
  documentFromJson,
